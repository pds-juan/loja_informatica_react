    ...
    return (
        <main class="principal">
            ...
            <aside class="onde-estamos">
                ...
                <h2>Contatos</h2>
                <ul>
                    <li><i class="fa-solid fa-phone"></i>(11) 4090-1030</li>
                    <li><a href="https://api.whatsapp.com/send?phone=551140901030" target="_blank"><i class="fa-brands fa-whatsapp"></i>(11) 4090-1030</a></li>
                    <li><a href="mailto:lapatito@sp.senac.br"><i class="fa-solid fa-envelope"></i>lapatito@sp.senac.br</a></li>
                </ul>
            </aside >
        </main >
    )
